...
radii = Dict.empty(key_type=unicode_type, value_type=float64[:])
# Shannon (1976) - Acta Crystallographica
# Updated values from
# Blundy and Wood (2003) - Reviews in Mineralogy and Geochemistry
# Wood and Blundy (2014) - Treatise on Geochemistry
...
part_coeff = Dict.empty(key_type=unicode_type, value_type=float64[:])
# McKenzie and O'Nions (1995) - Journal of Petrology
...
# McKenzie and O'Nions (1991) - Journal of Petrology
...
# Le Roux et al. (2015) - American Mineralogist
part_coeff_le_roux = {}
part_coeff_le_roux["Cu"] = array([0.13, 0.12, 0.09, nan, 0.25, 0.042])
part_coeff_le_roux["Ga"] = array([0.026, 0.38, 0.37, nan, 6.5, 0.39])
part_coeff_le_roux["Ge"] = array([0.43, 0.87, 0.87, nan, 0.4, 1.51])
part_coeff_le_roux["Ti"] = array([8e-3, 0.0656, 0.124, nan, 0.084, 0.262])
part_coeff_le_roux["Sc"] = array([0.15, 0.495, 0.84, nan, 0.058, 5.98])
part_coeff_le_roux["V"] = array([0.14, 1.06, 1.48, nan, 2.75, 1.84])
part_coeff_le_roux["Cr"] = array([0.79, 8.8, 7.5, nan, 54.0, 10.2])
part_coeff_le_roux["Mn"] = array([0.781, 0.640, 0.768, nan, 0.46, 1.241])
part_coeff_le_roux["Zn"] = array([0.96, 0.451, 0.333, nan, 5.2, 0.213])
part_coeff_le_roux["Fe"] = array([1.034, 0.55, 0.49, nan, 0.95, 0.654])
part_coeff_le_roux["Co"] = array([2.37, 1.29, 0.86, nan, 3.0, 0.83])
part_coeff_le_roux["Ni"] = array([6.2, 3.7, 22.0, nan, 10.0, 8.0])
# Wijbrans et al. (2015) - Contributions to Mineralogy and Petrology
...
# Fulmer et al. (2010) - Geochimica et Cosmochimica Acta
part_coeff_fulmer = {}
...
# Frei et al. (2009) - Contributions to Mineralogy and Petrology
...
# Adam and Green (2006) - Contributions to Mineralogy and Petrology
...
# McDade et al. (2003) - Physics of the Earth and Planetary Interiors
...
# Pertermann et al. (2004) - Geochemistry, Geophysics, Geosystems
part_coeff_pertermann = {}  # A343
part_coeff_pertermann["Na"] = array([nan, nan, nan, nan, nan, 0.0435])
# Klemme et al. (2002) - Geochemistry, Geophysics, Geosystems
part_coeff_klemme = {}
...
# Brunet and Chazot (2001) - Chemical Geology
part_coeff_brunet = {}
...
# fmt: off
# Salters and Stracke (2004) - Geochemistry, Geophysics, Geosystems
DM_SS_2004 = {
...
# Workman and Hart (2005) - Earth and Planetary Science Letters
DM_WH_2005 = {
...
# Boyet and Carlson (2006) - Earth and Planetary Science Letters
DM_BC_2006 = {
...
# McDonough and Sun (1995) - Chemical Geology
PM_MS_1995 = {
...
# Yaxley and Sobolev (2007) - Contributions to Mineralogy and Petrology
GB_YS_2007 = {
...
# Jordan, Pilet and Brenna (2022) - Journal of Petrology
PX_JP_2022 = {
...
# Duvernay et al. (2024) - Geochemistry, Geophysics, Geosystems
