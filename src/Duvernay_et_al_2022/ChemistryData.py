...
part_coeff["Sc"] = array([0.16, 0.33, 0.51, 0.02, 0., 2.27])
part_coeff["Ti"] = array([0.02, 0.1, 0.18, 0.04, 0.15, 0.28])
part_coeff["V"] = array([0.06, 0.9, 1.31, 0., 0., 1.57])
part_coeff["Cr"] = array([0.3, 1.5, 3., 0.05, 300., 5.5])
part_coeff["Mn"] = array([0.5, 0.7, 0.44, 0.05, 0.25, 2.05])
part_coeff["Co"] = array([1., 2., 2., 0.05, 2., 2.])
part_coeff["Ni"] = array([9.4, 9.4, 9.4, 0., 0., 0.])
part_coeff["Ga"] = array([0.04, 0.2, 0.74, 0., 5., 5.])
part_coeff["Rb"] = array([1.8e-4, 6e-4, 1e-3, 0.03, 1e-4, 7e-4])
part_coeff["Sr"] = array([1.9e-4, 7e-3, 0.13, 2., 0., 1.1e-3])
part_coeff["Y"] = array([5e-3, 5e-3, 0.2, 0.03, 0., 2.11])
part_coeff["Zr"] = array([0.01, 0.03, 0.1, 0.01, 0., 0.32])
part_coeff["Nb"] = array([5e-3, 5e-3, 0.02, 0.01, 0., 0.07])
part_coeff["Cs"] = array([5e-5, 1e-4, 2e-4, 0.025, 1e-4, 2e-4])
part_coeff["Ba"] = array([3e-4, 1e-4, 5e-4, 0.33, 1e-4, 5e-4])
part_coeff["Hf"] = array([0.01, 0.01, 0.22, 0.01, 0., 0.44])
...
part_coeff["Er"] = array([1.5e-3, 0.03, 0.3, 0.041, 0.01, 2.])
part_coeff["Tm"] = array([1.5e-3, 0.04, 0.29, 0.036, 0.01, 3.])
...
PM_MO_1995 = {"Na": 1800, "P": 61, "K": 200, "Sc": 12, "Ti": 1020, "V": 103,
              ...
              "Ba": 6.5, "Hf": 0.25, "Ta": 0.031, "Pb": 0.155, "Th": 0.07,
              "U": 0.018, "La": 0.55, "Ce": 1.4, "Pr": 0.22, "Nd": 1.08,
              "Sm": 0.35, "Eu": 0.13, "Gd": 0.457, "Tb": 0.084, "Dy": 0.57,
...
quad_poly_coeff["ol"] = array([9.01882440e-02, -9.69722650e-01, 3.49466809,
                               -1.53025982e-02, 8.51120402e-02, 1.11012556e-01,
                               2.75581072e-03, -2.46799325e-02, 0.583232594])
...
quad_poly_coeff["spl"] = array([0.27373059, -0.73296729, 0.4934069,
                                -0.1693379, 0.42934988, -0.34564207,
                                -0.01100667, 0.02665931, -0.00078246])
quad_poly_coeff["gnt"] = array([7.65368759e-02, -0.671020765, 0.632310288,
                                -5.92604369e-04, 4.96363848e-02, -0.349771905,
                                -1.04768368e-02, 0.127931359, -0.213965786])
