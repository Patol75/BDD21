...
class Katz:
    ...
    def KatzPTF(self, pressureStart, pressureEnd, tempStart, Fstart, dTdP_GPa):
...
def figure_2(original_params):
    temperatures = linspace(1000, 2000, 1001) + 273.15
    F = empty_like(temperatures)
    katz = Katz(original_params=original_params)
